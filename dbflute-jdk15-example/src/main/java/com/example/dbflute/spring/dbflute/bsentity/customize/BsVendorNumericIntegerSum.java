 ...
 */
public abstract class BsVendorNumericIntegerSum implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.spring.dbflute.bsentity.customize.dbmeta.VendorNumericIntegerSumDbm.getInstance();
    }
