...
public abstract class BsMemberBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Member> ENTITY doSelectEntity(final MemberCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, new InternalSelectEntityCallback<ENTITY, MemberCB>() {
            public List<ENTITY> callbackSelectList(MemberCB cb) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends Member> ENTITY doSelectEntityWithDeletedCheck(final MemberCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, MemberCB>() {
            public List<ENTITY> callbackSelectList(MemberCB cb) { return doSelectList(cb, entityType); } });
    }
     ...
     * (会員住所情報)MEMBER_ADDRESS by your MEMBER_ID, named 'memberAddressList'.
     * <pre>
     ...
     * (会員ログイン)MEMBER_LOGIN by your MEMBER_ID, named 'memberLoginList'.
     * <pre>
     ...
     * (購入)PURCHASE by your MEMBER_ID, named 'purchaseList'.
     * <pre>
     ...
     * </pre>
     * @param member The entity of delete target. (NotNull) {PrimaryKeyRequired}
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted.
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
    ...
    protected int doQueryUpdate(Member member, MemberCB cb, UpdateOption<MemberCB> option) {
        ...
        prepareUpdateOption(option);
        return delegateQueryUpdate(member, cb, option);
    }
