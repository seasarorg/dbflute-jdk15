...
public abstract class BsVendorIdentityOnlyBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends VendorIdentityOnly> ENTITY doSelectEntity(final VendorIdentityOnlyCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, new InternalSelectEntityCallback<ENTITY, VendorIdentityOnlyCB>() {
            public List<ENTITY> callbackSelectList(VendorIdentityOnlyCB cb) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends VendorIdentityOnly> ENTITY doSelectEntityWithDeletedCheck(final VendorIdentityOnlyCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, VendorIdentityOnlyCB>() {
            public List<ENTITY> callbackSelectList(VendorIdentityOnlyCB cb) { return doSelectList(cb, entityType); } });
    }
     ...
     * </pre>
     * @param vendorIdentityOnly The entity of insert target. (NotNull)
     ...
     * } 
     * </pre>
     * @param vendorIdentityOnly The entity of update target. (NotNull) {PrimaryKeyRequired, ConcurrencyColumnRequired}
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted.
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (Unique Constraint Violation)
     */
     ...
     * } 
     * </pre>
     * @param vendorIdentityOnly The entity of delete target. (NotNull) {PrimaryKeyRequired, ConcurrencyColumnRequired}
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted.
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
     ...
     * @param vendorIdentityOnlyList The list of the entity. (NotNull)
    ...
    protected int doQueryUpdate(VendorIdentityOnly vendorIdentityOnly, VendorIdentityOnlyCB cb, UpdateOption<VendorIdentityOnlyCB> option) {
        ...
        prepareUpdateOption(option);
        return delegateQueryUpdate(vendorIdentityOnly, cb, option);
    }
