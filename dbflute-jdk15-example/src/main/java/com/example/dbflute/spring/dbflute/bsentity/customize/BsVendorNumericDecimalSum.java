 ...
 */
public abstract class BsVendorNumericDecimalSum implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsVendorNumericDecimalSum)) { return false; }
        BsVendorNumericDecimalSum otherEntity = (BsVendorNumericDecimalSum)other;
        if (!xSV(getDecimalDigitSum(), otherEntity.getDecimalDigitSum())) { return false; }
        return true;
    }
