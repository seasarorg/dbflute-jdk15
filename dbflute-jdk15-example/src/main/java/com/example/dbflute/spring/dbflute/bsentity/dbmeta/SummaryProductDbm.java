...
public class SummaryProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, false, "productId", Integer.class, true, false, "INTEGER", 10, 0, false, null, null, null, "purchaseList", null);
    ...
    protected final ColumnInfo _columnProductStatusCode = cci("PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", null, null, false, "productStatusCode", String.class, false, false, "CHAR", 3, 0, false, null, null, "productStatus", null, CDef.DefMeta.ProductStatus);
    ...
    public ForeignInfo foreignProductStatus() {
        ...
        return cfi("productStatus", this, ProductStatusDbm.getInstance(), map, 0, false, false, true, "summaryProductList");
    }
    ...
    public ReferrerInfo referrerPurchaseList() {
        ...
        return cri("purchaseList", this, PurchaseDbm.getInstance(), map, false, "summaryProduct");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.spring.dbflute.exentity.SummaryProduct"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.spring.dbflute.cbean.SummaryProductCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.SummaryProductDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.spring.dbflute.exbhv.SummaryProductBhv"; }
