 ...
 */
public abstract class BsPmCommentOrderByIf implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.spring.dbflute.bsentity.customize.dbmeta.PmCommentOrderByIfDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPmCommentOrderByIf)) { return false; }
        BsPmCommentOrderByIf otherEntity = (BsPmCommentOrderByIf)other;
