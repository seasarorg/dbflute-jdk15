...
public class BsVendor$DollarCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;Vendor$DollarCB&gt;() {
    ...
    public void union(UnionQuery<Vendor$DollarCB> unionQuery) {
        final Vendor$DollarCB cb = new Vendor$DollarCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;Vendor$DollarCB&gt;() {
     *     public void query(Vendor$DollarCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;Vendor$DollarCB&gt;() {
    ...
    public HpColQyOperand<Vendor$DollarCB> columnQuery(final SpecifyQuery<Vendor$DollarCB> leftSpecifyQuery) {
        return new HpColQyOperand<Vendor$DollarCB>(new HpColQyHandler<Vendor$DollarCB>() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;Vendor$DollarCB&gt;() {
     ...
     *     public void query(Vendor$DollarCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;Vendor$DollarCB&gt;() {
