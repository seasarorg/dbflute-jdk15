...
public interface CDef extends Classification {
    ...
    public enum MemberStatus implements CDef {
        ...
        Formalized("FML", "FORMALIZED", new String[] {})
        ,
        /** WITHDRAWAL: withdrawal is fixed, not allowed to use service */
        Withdrawal("WDL", "WITHDRAWAL", new String[] {})
        ,
        /** PROVISIONAL: first status after entry, allowed to use only part of service */
        Provisional("PRV", "PROVISIONAL", new String[] {})
        ;
    ...
    public enum ServiceRank implements CDef {
        ...
        Platinum("PLT", "PLATINUM", new String[] {})
        ,
        /** GOLD: gold rank */
        Gold("GLD", "GOLD", new String[] {})
        ,
        /** SILVER: silver rank */
        Silver("SIL", "SILVER", new String[] {})
        ,
        /** BRONZE: bronze rank */
        Bronze("BRZ", "BRONZE", new String[] {})
        ,
        /** PLASTIC: plastic rank */
        Plastic("PLS", "PLASTIC", new String[] {})
        ;
    ...
    public enum Region implements CDef {
        /** AMERICA */
        America("1", "AMERICA", new String[] {})
        ,
        /** CANADA */
        Canada("2", "CANADA", new String[] {})
        ,
        /** CHINA */
        China("3", "CHINA", new String[] {})
        ,
        /** CHIBA */
        Chiba("4", "CHIBA", new String[] {})
        ;
    ...
    public enum WithdrawalReason implements CDef {
        /** SIT: サイトが使いにくいから */
        Sit("SIT", "SIT", new String[] {})
        ,
        /** PRD: 商品に魅力がないから */
        Prd("PRD", "PRD", new String[] {})
        ,
        /** FRT: フリテンだから */
        Frt("FRT", "FRT", new String[] {})
        ,
        /** OTH: その他理由 */
        Oth("OTH", "OTH", new String[] {})
        ;
    ...
    public enum ProductCategory implements CDef {
        /** 音楽 */
        音楽("MSC", "音楽", new String[] {})
        ,
        /** 食品 */
        食品("FOD", "食品", new String[] {})
        ,
        /** ハーブ: of 食品 */
        ハーブ("HEB", "ハーブ", new String[] {})
        ,
        /** 音楽CD: of 音楽 */
        音楽cd("MCD", "音楽CD", new String[] {})
        ,
        /** 楽器: of 音楽 */
        楽器("INS", "楽器", new String[] {})
        ;
    ...
    public enum ProductStatus implements CDef {
        /** 生産販売可能 */
        生産販売可能("ONS", "生産販売可能", new String[] {})
        ,
        /** 生産中止 */
        生産中止("PST", "生産中止", new String[] {})
        ,
        /** 販売中止 */
        販売中止("SST", "販売中止", new String[] {})
        ;
