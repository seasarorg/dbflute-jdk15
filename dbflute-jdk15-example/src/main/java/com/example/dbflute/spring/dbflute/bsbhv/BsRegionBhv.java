...
public abstract class BsRegionBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends Region> ENTITY doSelectEntity(final RegionCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, new InternalSelectEntityCallback<ENTITY, RegionCB>() {
            public List<ENTITY> callbackSelectList(RegionCB cb) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends Region> ENTITY doSelectEntityWithDeletedCheck(final RegionCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, RegionCB>() {
            public List<ENTITY> callbackSelectList(RegionCB cb) { return doSelectList(cb, entityType); } });
    }
     ...
     * </pre>
     * @param region The entity of insert target. (NotNull)
     ...
     * } 
     * </pre>
     * @param region The entity of update target. (NotNull) {PrimaryKeyRequired, ConcurrencyColumnRequired}
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted.
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (Unique Constraint Violation)
     */
     ...
     * } 
     * </pre>
     * @param region The entity of delete target. (NotNull) {PrimaryKeyRequired, ConcurrencyColumnRequired}
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted.
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
     ...
     * @param regionList The list of the entity. (NotNull)
    ...
    protected int doQueryUpdate(Region region, RegionCB cb, UpdateOption<RegionCB> option) {
        ...
        prepareUpdateOption(option);
        return delegateQueryUpdate(region, cb, option);
    }
