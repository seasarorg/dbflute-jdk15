...
public abstract class BsSummaryWithdrawalBhv extends AbstractBehaviorReadable {
    ...
    protected <ENTITY extends SummaryWithdrawal> ENTITY doSelectEntity(final SummaryWithdrawalCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, new InternalSelectEntityCallback<ENTITY, SummaryWithdrawalCB>() {
            public List<ENTITY> callbackSelectList(SummaryWithdrawalCB cb) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends SummaryWithdrawal> ENTITY doSelectEntityWithDeletedCheck(final SummaryWithdrawalCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, SummaryWithdrawalCB>() {
            public List<ENTITY> callbackSelectList(SummaryWithdrawalCB cb) { return doSelectList(cb, entityType); } });
    }
