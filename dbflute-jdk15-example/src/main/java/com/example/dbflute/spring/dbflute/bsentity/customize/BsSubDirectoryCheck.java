 ...
 */
public abstract class BsSubDirectoryCheck implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.spring.dbflute.bsentity.customize.dbmeta.SubDirectoryCheckDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSubDirectoryCheck)) { return false; }
        BsSubDirectoryCheck otherEntity = (BsSubDirectoryCheck)other;
