...
public abstract class BsVendorPrimaryKeyOnlyBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends VendorPrimaryKeyOnly> ENTITY doSelectEntity(final VendorPrimaryKeyOnlyCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, new InternalSelectEntityCallback<ENTITY, VendorPrimaryKeyOnlyCB>() {
            public List<ENTITY> callbackSelectList(VendorPrimaryKeyOnlyCB cb) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends VendorPrimaryKeyOnly> ENTITY doSelectEntityWithDeletedCheck(final VendorPrimaryKeyOnlyCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, VendorPrimaryKeyOnlyCB>() {
            public List<ENTITY> callbackSelectList(VendorPrimaryKeyOnlyCB cb) { return doSelectList(cb, entityType); } });
    }
     ...
     * </pre>
     * @param vendorPrimaryKeyOnly The entity of insert target. (NotNull)
     ...
     * } 
     * </pre>
     * @param vendorPrimaryKeyOnly The entity of update target. (NotNull) {PrimaryKeyRequired, ConcurrencyColumnRequired}
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted.
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (Unique Constraint Violation)
     */
     ...
     * } 
     * </pre>
     * @param vendorPrimaryKeyOnly The entity of delete target. (NotNull) {PrimaryKeyRequired, ConcurrencyColumnRequired}
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted.
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
     ...
     * @param vendorPrimaryKeyOnlyList The list of the entity. (NotNull)
    ...
    protected int doQueryUpdate(VendorPrimaryKeyOnly vendorPrimaryKeyOnly, VendorPrimaryKeyOnlyCB cb, UpdateOption<VendorPrimaryKeyOnlyCB> option) {
        ...
        prepareUpdateOption(option);
        return delegateQueryUpdate(vendorPrimaryKeyOnly, cb, option);
    }
