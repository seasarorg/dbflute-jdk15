...
public class BsMemberAddressCQ extends AbstractBsMemberAddressCQ {
     ...
     * (会員住所ID)MEMBER_ADDRESS_ID: {PK, NotNull, INTEGER(10)}
     * @return this. (NotNull)
     */
    ...
    public String keepRegionId_InScopeRelation_Region(RegionCQ subQuery) {
        if (_regionId_InScopeRelation_RegionMap == null) { _regionId_InScopeRelation_RegionMap = newLinkedHashMap(); }
    ...
    public String keepRegionId_NotInScopeRelation_Region(RegionCQ subQuery) {
        if (_regionId_NotInScopeRelation_RegionMap == null) { _regionId_NotInScopeRelation_RegionMap = newLinkedHashMap(); }
