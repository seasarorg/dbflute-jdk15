...
/**
 * The entity of PmCommentCollection. <br />
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsPmCommentCollection implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.spring.dbflute.bsentity.customize.dbmeta.PmCommentCollectionDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsPmCommentCollection)) { return false; }
        BsPmCommentCollection otherEntity = (BsPmCommentCollection)other;
     ...
     */
    public PmCommentCollection clone() {
        try {
            return (PmCommentCollection)super.clone();
