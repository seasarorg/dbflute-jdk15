...
public class VendorIdentityOnlyDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnIdentityOnlyId = cci("IDENTITY_ONLY_ID", "IDENTITY_ONLY_ID", null, null, true, "identityOnlyId", Long.class, true, true, "BIGINT", 19, 0, false, null, null, null, null, null);
    ...
    //                                       Primary Element
    //                                       ---------------
    public UniqueInfo getPrimaryUniqueInfo() { return cpui(columnIdentityOnlyId()); }
    ...
    public String getDaoTypeName() { return "${glPackageExtendedDao}.VendorIdentityOnlyDao"; }
