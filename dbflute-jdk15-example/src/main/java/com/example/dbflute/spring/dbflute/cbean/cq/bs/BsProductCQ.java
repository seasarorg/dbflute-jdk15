...
public class BsProductCQ extends AbstractBsProductCQ {
    ...
    public String keepProductCategoryCode_InScopeRelation_ProductCategory(ProductCategoryCQ subQuery) {
        if (_productCategoryCode_InScopeRelation_ProductCategoryMap == null) { _productCategoryCode_InScopeRelation_ProductCategoryMap = newLinkedHashMap(); }
    ...
    public String keepProductCategoryCode_NotInScopeRelation_ProductCategory(ProductCategoryCQ subQuery) {
        if (_productCategoryCode_NotInScopeRelation_ProductCategoryMap == null) { _productCategoryCode_NotInScopeRelation_ProductCategoryMap = newLinkedHashMap(); }
