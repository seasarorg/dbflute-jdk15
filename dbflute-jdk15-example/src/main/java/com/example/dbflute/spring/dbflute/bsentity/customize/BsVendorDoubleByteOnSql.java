 ...
 */
public abstract class BsVendorDoubleByteOnSql implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.spring.dbflute.bsentity.customize.dbmeta.VendorDoubleByteOnSqlDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsVendorDoubleByteOnSql)) { return false; }
        BsVendorDoubleByteOnSql otherEntity = (BsVendorDoubleByteOnSql)other;
