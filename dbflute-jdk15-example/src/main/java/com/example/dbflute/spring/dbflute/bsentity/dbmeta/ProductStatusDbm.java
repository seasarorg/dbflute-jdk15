...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductStatusCode = cci("PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", null, "商品ステータスコード", true, "productStatusCode", String.class, true, false, "CHAR", 3, 0, false, null, "商品ステータスを識別するコード。", null, "productList,summaryProductList", CDef.DefMeta.ProductStatus);
    ...
    public ReferrerInfo referrerSummaryProductList() {
        ...
        return cri("summaryProductList", this, SummaryProductDbm.getInstance(), map, false, "productStatus");
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.spring.dbflute.exentity.ProductStatus"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.spring.dbflute.cbean.ProductStatusCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.ProductStatusDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.spring.dbflute.exbhv.ProductStatusBhv"; }
