...
public class SummaryWithdrawalDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.spring.dbflute.exentity.SummaryWithdrawal"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.spring.dbflute.cbean.SummaryWithdrawalCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.SummaryWithdrawalDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.spring.dbflute.exbhv.SummaryWithdrawalBhv"; }
