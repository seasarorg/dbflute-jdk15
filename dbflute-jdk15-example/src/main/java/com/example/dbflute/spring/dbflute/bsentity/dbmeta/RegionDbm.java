...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, "地域ID", true, "regionId", Integer.class, true, false, "INTEGER", 10, 0, false, null, "地域を識別するID。\n珍しく(固定的な)マスタテーブルとしては数値だが、\nExampleなのでやはり色々なパターンがないと。", null, "memberAddressList", CDef.DefMeta.Region);
    protected final ColumnInfo _columnRegionName = cci("REGION_NAME", "REGION_NAME", null, "地域名称", true, "regionName", String.class, false, false, "VARCHAR", 50, 0, false, null, "地域を表す名称。", null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.example.dbflute.spring.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "com.example.dbflute.spring.dbflute.cbean.RegionCB"; }
    public String getDaoTypeName() { return "${glPackageExtendedDao}.RegionDao"; }
    public String getBehaviorTypeName() { return "com.example.dbflute.spring.dbflute.exbhv.RegionBhv"; }
