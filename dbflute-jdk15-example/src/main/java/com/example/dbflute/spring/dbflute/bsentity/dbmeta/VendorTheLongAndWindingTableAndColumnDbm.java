...
public class VendorTheLongAndWindingTableAndColumnDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnTheLongAndWindingTableAndColumnId = cci("THE_LONG_AND_WINDING_TABLE_AND_COLUMN_ID", "THE_LONG_AND_WINDING_TABLE_AND_COLUMN_ID", null, null, true, "theLongAndWindingTableAndColumnId", Long.class, true, false, "BIGINT", 19, 0, false, null, null, null, "vendorTheLongAndWindingTableAndColumnRefList", null);
    protected final ColumnInfo _columnTheLongAndWindingTableAndColumnName = cci("THE_LONG_AND_WINDING_TABLE_AND_COLUMN_NAME", "THE_LONG_AND_WINDING_TABLE_AND_COLUMN_NAME", null, null, true, "theLongAndWindingTableAndColumnName", String.class, false, false, "VARCHAR", 200, 0, false, null, null, null, null, null);
    protected final ColumnInfo _columnShortName = cci("SHORT_NAME", "SHORT_NAME", null, null, true, "shortName", String.class, false, false, "VARCHAR", 200, 0, false, null, null, null, null, null);
    protected final ColumnInfo _columnShortSize = cci("SHORT_SIZE", "SHORT_SIZE", null, null, true, "shortSize", Integer.class, false, false, "INTEGER", 10, 0, false, null, null, null, null, null);
    ...
    //                                       Primary Element
    //                                       ---------------
    public UniqueInfo getPrimaryUniqueInfo() { return cpui(columnTheLongAndWindingTableAndColumnId()); }
    ...
    public ReferrerInfo referrerVendorTheLongAndWindingTableAndColumnRefList() {
        ...
        return cri("vendorTheLongAndWindingTableAndColumnRefList", this, VendorTheLongAndWindingTableAndColumnRefDbm.getInstance(), map, false, "vendorTheLongAndWindingTableAndColumn");
    }
    ...
    public String getDaoTypeName() { return "${glPackageExtendedDao}.VendorTheLongAndWindingTableAndColumnDao"; }
