 ...
 */
public abstract class BsSurpriseSimilarPKComment implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.spring.dbflute.bsentity.customize.dbmeta.SurpriseSimilarPKCommentDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSurpriseSimilarPKComment)) { return false; }
        BsSurpriseSimilarPKComment otherEntity = (BsSurpriseSimilarPKComment)other;
