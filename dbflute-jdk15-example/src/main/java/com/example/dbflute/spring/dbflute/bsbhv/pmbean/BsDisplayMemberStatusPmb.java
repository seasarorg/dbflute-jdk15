...
/**
 * The base class for parameter-bean of DisplayMemberStatus.
 * @author DBFlute(AutoGenerator)
 */
public class BsDisplayMemberStatusPmb implements ParameterBean, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the parameter-bean of DisplayMemberStatus.
     */
    public BsDisplayMemberStatusPmb() {
    }
