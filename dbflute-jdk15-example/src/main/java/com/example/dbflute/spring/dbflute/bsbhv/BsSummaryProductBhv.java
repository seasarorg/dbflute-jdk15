...
public abstract class BsSummaryProductBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends SummaryProduct> ENTITY doSelectEntity(final SummaryProductCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, new InternalSelectEntityCallback<ENTITY, SummaryProductCB>() {
            public List<ENTITY> callbackSelectList(SummaryProductCB cb) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends SummaryProduct> ENTITY doSelectEntityWithDeletedCheck(final SummaryProductCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, SummaryProductCB>() {
            public List<ENTITY> callbackSelectList(SummaryProductCB cb) { return doSelectList(cb, entityType); } });
    }
     ...
     * (購入)PURCHASE by your PRODUCT_ID, named 'purchaseList'.
     * <pre>
    ...
    protected int doQueryUpdate(SummaryProduct summaryProduct, SummaryProductCB cb, UpdateOption<SummaryProductCB> option) {
        ...
        prepareUpdateOption(option);
        return delegateQueryUpdate(summaryProduct, cb, option);
    }
