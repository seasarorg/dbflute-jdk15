 ...
 */
public abstract class BsForcedType implements Entity, Serializable, Cloneable {
    ...
    public DBMeta getDBMeta() {
        return com.example.dbflute.spring.dbflute.bsentity.customize.dbmeta.ForcedTypeDbm.getInstance();
    }
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsForcedType)) { return false; }
        BsForcedType otherEntity = (BsForcedType)other;
        if (!xSV(getMaxMemberId(), otherEntity.getMaxMemberId())) { return false; }
        return true;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getMaxMemberId());
