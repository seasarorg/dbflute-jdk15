...
public class VendorPrimaryKeyOnlyDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPrimaryKeyOnlyId = cci("PRIMARY_KEY_ONLY_ID", "PRIMARY_KEY_ONLY_ID", null, null, true, "primaryKeyOnlyId", Long.class, true, false, "BIGINT", 19, 0, false, null, null, null, null, null);
    ...
    //                                       Primary Element
    //                                       ---------------
    public UniqueInfo getPrimaryUniqueInfo() { return cpui(columnPrimaryKeyOnlyId()); }
    ...
    public String getDaoTypeName() { return "${glPackageExtendedDao}.VendorPrimaryKeyOnlyDao"; }
