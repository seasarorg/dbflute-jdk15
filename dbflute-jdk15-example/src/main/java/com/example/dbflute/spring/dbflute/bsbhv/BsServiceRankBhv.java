...
public abstract class BsServiceRankBhv extends AbstractBehaviorWritable {
    ...
    protected <ENTITY extends ServiceRank> ENTITY doSelectEntity(final ServiceRankCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityInternally(cb, new InternalSelectEntityCallback<ENTITY, ServiceRankCB>() {
            public List<ENTITY> callbackSelectList(ServiceRankCB cb) { return doSelectList(cb, entityType); } });
    }
    ...
    protected <ENTITY extends ServiceRank> ENTITY doSelectEntityWithDeletedCheck(final ServiceRankCB cb, final Class<ENTITY> entityType) {
        assertCBStateValid(cb);
        return helpSelectEntityWithDeletedCheckInternally(cb, new InternalSelectEntityWithDeletedCheckCallback<ENTITY, ServiceRankCB>() {
            public List<ENTITY> callbackSelectList(ServiceRankCB cb) { return doSelectList(cb, entityType); } });
    }
     ...
     * </pre>
     * @param serviceRank The entity of insert target. (NotNull)
     ...
     * } 
     * </pre>
     * @param serviceRank The entity of update target. (NotNull) {PrimaryKeyRequired, ConcurrencyColumnRequired}
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted.
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     * @exception org.seasar.dbflute.exception.EntityAlreadyExistsException When the entity already exists. (Unique Constraint Violation)
     */
     ...
     * } 
     * </pre>
     * @param serviceRank The entity of delete target. (NotNull) {PrimaryKeyRequired, ConcurrencyColumnRequired}
     * @exception org.seasar.dbflute.exception.EntityAlreadyDeletedException When the entity has already been deleted.
     * @exception org.seasar.dbflute.exception.EntityDuplicatedException When the entity has been duplicated.
     */
     ...
     * @param serviceRankList The list of the entity. (NotNull)
    ...
    protected int doQueryUpdate(ServiceRank serviceRank, ServiceRankCB cb, UpdateOption<ServiceRankCB> option) {
        ...
        prepareUpdateOption(option);
        return delegateQueryUpdate(serviceRank, cb, option);
    }
