...
public abstract class BsVendorPrimaryKeyOnly implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsVendorPrimaryKeyOnly)) { return false; }
        BsVendorPrimaryKeyOnly otherEntity = (BsVendorPrimaryKeyOnly)other;
        if (!xSV(getPrimaryKeyOnlyId(), otherEntity.getPrimaryKeyOnlyId())) { return false; }
        return true;
    }
    ...
    protected String buildColumnString() {
        StringBuilder sb = new StringBuilder();
        String delimiter = ", ";
        sb.append(delimiter).append(getPrimaryKeyOnlyId());
