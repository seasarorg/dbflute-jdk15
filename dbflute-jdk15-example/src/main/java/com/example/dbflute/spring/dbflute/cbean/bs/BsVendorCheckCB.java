...
public class BsVendorCheckCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;VendorCheckCB&gt;() {
    ...
    public void union(UnionQuery<VendorCheckCB> unionQuery) {
        final VendorCheckCB cb = new VendorCheckCB();
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;VendorCheckCB&gt;() {
     *     public void query(VendorCheckCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;VendorCheckCB&gt;() {
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;VendorCheckCB&gt;() {
     ...
     *     public void query(VendorCheckCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorCheckCB&gt;() {
