...
-- !!$$CDef$$ cdef!!
-- !!$$CDef$$.Flg cdefFlg!!
-- !!List<$$CDef$$.MemberStatus> cdefList:ref(MEMBER.MEMBER_STATUS_CODE)!!
-- !!List<$$CDef$$.MemberStatus> memberStatusCodeList:ref(MEMBER)!!
-- !!$$Domain$$.Member member!!
-- !!$$Customize$$.SimpleMember simpleMember!!
-- !!$$Pmb$$.SimpleMemberPmb simpleMemberPmb!!
